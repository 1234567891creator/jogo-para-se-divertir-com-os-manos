      ...
      <div className="flex items-start justify-between">
        ...
        <div className="pointer-events-auto flex items-center gap-2">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-xs font-medium backdrop-blur-md transition-colors ${
              lanternBrightness === 'max'
                ? 'border-amber-400/80 bg-amber-950/80 text-amber-200 shadow-md shadow-amber-900/30'
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-cyan-700/80 bg-cyan-950/85 px-3 py-1.5 text-xs font-medium text-cyan-200 backdrop-blur-md transition-colors hover:border-cyan-400 hover:text-white shadow-md shadow-cyan-950/40"
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-slate-700/80 bg-slate-900/85 px-2.5 py-1.5 text-xs font-medium text-slate-200 backdrop-blur-md transition-colors hover:border-cyan-500 hover:text-cyan-200 shadow-sm"
            title={`Velocidade da Animação: ${currentFps} FPS (Clique para alternar: 2 FPS, 4 FPS, 5 FPS, 8 FPS, 12 FPS)`}
          >
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-700/80 bg-slate-900/85 text-slate-300 backdrop-blur-md transition-colors hover:border-slate-500 hover:text-white"
            title={isMuted ? 'Ativar Áudio' : 'Mutar Áudio'}
          >
            {isMuted ? <VolumeX className="h-4 w-4 text-red-400" /> : <Volume2 className="h-4 w-4 text-slate-300" />}
          </button>

          {/* Map Button */}
          <button
            onClick={onOpenMap}
            className="flex items-center gap-1.5 rounded-lg border border-slate-700/80 bg-slate-900/85 px-3 py-1.5 text-xs font-medium text-slate-200 backdrop-blur-md transition-colors hover:border-slate-500 hover:text-white"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-cyan-800/80 bg-cyan-950/85 px-3 py-1.5 text-xs font-medium text-cyan-200 backdrop-blur-md transition-colors hover:border-cyan-500 hover:text-white"
          >
